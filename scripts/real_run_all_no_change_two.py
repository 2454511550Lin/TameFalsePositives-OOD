...
root_pfx  = "real-exp-supp-ood1-rebutt"
...
lst_methods           = ['tpr_95','fpr_5','adaood2']
...
d_method_params = {'no-ucb': no_ucb_params,'hoeffding':heoffding_params,
                   'lil-heuristic':lil_heuristic_params, 
                   'tpr_95':tpr_95_params,'fpr_5':fpr_5_params,
                   'adaood2': adaood2_params}
