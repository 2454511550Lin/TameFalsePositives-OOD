...
root_pfx  = "real-exp-supp-change"

conf_dir  =  os.path.join(root_dir , "configs" ) 

base_conf = OmegaConf.load(os.path.join( conf_dir, f"base_config_real_change_imagenet.yaml")) 
...
#lst_methods = ['lil-heuristic']
lst_scores           = ['GRADNORM', 'ASH', 'REACT']#,'IDECODE'] 
lst_id_ds            = ['imagenet1k']
#lst_id_ds            = ['cifar100']

lst_alpha            = [0.05]
lst_probs            = [0.2]
lst_window           = [None,5000,10000]
