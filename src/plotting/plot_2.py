...
def plot_one_run_average(path,seeds):
    ...
    fig.savefig(os.path.join(path,'tpr_fpr_no_break.png'), dpi=200,bbox_inches='tight')
    plt.close(fig)
...
if __name__ == "__main__":
    ...
    paths = ['/home/heguang/OpenOOD/simulation/sim_result_aistats/#in_[44000, 36000]_#out_[11000, 9000]_indis_[[5.5, 4], [5.5, 4]]_outdis_[[-6, 4], [-5, 4]]_win_20000',
             '/home/heguang/OpenOOD/simulation/sim_result_aistats/#in_[44000, 36000]_#out_[11000, 9000]_indis_[[5.5, 4], [5.5, 4]]_outdis_[[-6, 4], [-5, 4]]_win_30000']
