...
root_pfx = '../../outputs/synthetic-exp-id-change/'
...
for window in lst_windows:
    ...
    #plt.tight_layout()
    if(hoeffding):
        plt.savefig(f'../../plots-supp-2/sim_id_change/sim_id_change_plot_window_{window}_gamma_{gamma}_hfding.png',dpi=150,bbox_inches='tight')
    else:
        plt.savefig(f'../../plots-supp-2/sim_id_change/sim_id_change_plot_window_{window}_gamma_{gamma}.png',dpi=150,bbox_inches='tight')
